  ...
  Widget build(BuildContext context) {
    ...
    //     ),
        GestureDetector(
          ...
          child: Icon(Icons.arrow_back_ios_new_outlined,color: AppColor.orangeColor,size: 18,),
        ),
        ...
        GestureDetector(
          onTap: (){
            _changePage(++currentPage);          },
          child: Icon(Icons.arrow_forward_ios_rounded,color: AppColor.orangeColor,size: 18,),
