              ...
              child: Responsive.isDesktop(context)?Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(child: Text("Create New Password", style: const TextStyle().normal22w400,)),
                      const Gap(8),
                      Text("Your new password must be different from previous used passwords.",style: const TextStyle().normal16w400g,textAlign: TextAlign.center,),
                      const Gap(17),
                      Container(
                        decoration: BoxDecoration(
                        ...
                        child: InputField(
                          ...
                          hintStyle: const TextStyle().normal16w400g.textColor(
                              AppColor.gray3Color),
                      ...
                      const Gap(17),
                      Text("Must be at least 8 characters.",style: const TextStyle().normal16w400g.textColor(
                          AppColor.gray3Color),),
                      const Gap(17),
                      Container(
                        decoration: BoxDecoration(
                      ...
                      Text("Both password must match.",
                        style: const TextStyle().normal16w400g.textColor(
                            AppColor.gray3Color),),
                      const Spacer(),
                      CommonButton(
                        onTap: (){
